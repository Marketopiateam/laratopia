                ...
                <tbody>
                    @forelse($designs as $design)
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-relationship">{{ $design->statues_label }}</span>
                            </td>
                            <td>
                                <span class="badge badge-relationship">{{ $design->confirmation_label }}</span>
                            </td>
                            <td>
                                {{ $design->note }}
                            </td>
                            <td>
                                <span class="badge badge-relationship">{{ $design->review_label }}</span>
                            </td>
                            <td>
                                {{ $design->updated_at }}
                            </td>
