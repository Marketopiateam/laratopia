                ...
                <tbody>
                    @forelse($videos as $video)
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-relationship">{{ $video->status_label }}</span>
                            </td>
                            <td>
                                <span class="badge badge-relationship">{{ $video->confirmation_label }}</span>
                            </td>
                            <td>
                                {{ $video->notes }}
                            </td>
                            <td>
                                <span class="badge badge-relationship">{{ $video->review_label }}</span>
                            </td>
                            <td>
                                {{ $video->updated_at }}
                            </td>
